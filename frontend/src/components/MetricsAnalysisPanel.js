...
function MetricsAnalysisPanel({ projectId, panelId, onRemove, canRemove, title }) {
  ...
  return (
    <div className="metrics-analysis-panel">
      ...
      <div className="metrics-form">
        <div className="form-row">
          <div className="form-group">
            <label htmlFor={`x-axis-metric-${panelId}`}>X-Axis Metric</label>
            <select
              id={`x-axis-metric-${panelId}`}
              value={xAxisMetric}
          ...
          <div className="form-group">
            <label htmlFor={`y-axis-metric-${panelId}`}>
        ...
        <div className="form-row">
          <div className="form-group">
            <label htmlFor={`start-date-${panelId}`}>Start Date</label>
            <input
              type="date"
              id={`start-date-${panelId}`}
              value={startDate}
          ...
          <div className="form-group">
            <label htmlFor={`end-date-${panelId}`}>End Date</label>
            <input
              type="date"
              id={`end-date-${panelId}`}
              value={endDate}
          ...
          <div className="form-group">
            <label htmlFor={`intervals-${panelId}`}>Intervals</label>
            <input
              type="number"
              id={`intervals-${panelId}`}
              min="1"
              max="100"
              value={intervals}
...
export default MetricsAnalysisPanel;
